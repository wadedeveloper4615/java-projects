...
class ObjectGeneratorTest {
	...
	List<Object> result = objectGenerator.generateDifferentObjects(classAndFieldPredicatePair);
	// then
	assertThat(result).hasSize(16).doesNotHaveDuplicates();
    }
	...
	RecursivelyDifferentObjectTestCase case1 = new RecursivelyDifferentObjectTestCase(18, pair(D.class), pair1);
	RecursivelyDifferentObjectTestCase case2 = new RecursivelyDifferentObjectTestCase(6, pair(G.class), pair2);
	RecursivelyDifferentObjectTestCase case3 = new RecursivelyDifferentObjectTestCase(945, pair(H.class), pair3);
    ...
    private Executable Should_Generate_Different_Objects_Recursively(RecursivelyDifferentObjectTestCase testCase) {
	return () -> {
	    // given
	    ObjectGenerator objectGenerator = makeObjectGenerator(abstractFieldValueChanger, constructorParameters);
	    // when
