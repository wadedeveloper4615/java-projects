...
class BigIntegerValueChangerTest {
	...
	return Stream.of(BigInteger.TEN, BigInteger.ZERO, BigInteger.ONE, BigInteger.valueOf(999999999999999999L)).map(value -> dynamicTest(getDefaultDisplayName(value), Should_Change_Value(value)));
    }
	...
	return Stream.of(new TestCase(null, null, false), new TestCase(BigInteger.ZERO, BigInteger.ZERO, false), new TestCase(BigInteger.valueOf(-999999999999999999L), BigInteger.valueOf(-999999999999999999L), false), new TestCase(BigInteger.valueOf(999999999999999999L), BigInteger.valueOf(999999999999999999L), false), new TestCase(BigInteger.ZERO, BigInteger.ONE, true), new TestCase(BigInteger.ZERO, null, true), new TestCase(null, BigInteger.valueOf(-999999999999999999L), true),
		new TestCase(BigInteger.valueOf(-999999999999999999L), BigInteger.valueOf(999999999999999999L), true), new TestCase(BigInteger.valueOf(999999999999999999L), BigInteger.valueOf(-999999999999999999L), true)).map(value -> dynamicTest(getDefaultDisplayName(value.value1 + " " + value.value2), Should_Return_True_Or_False_Whether_Values_Are_Different_Or_Not(value)));
    }
