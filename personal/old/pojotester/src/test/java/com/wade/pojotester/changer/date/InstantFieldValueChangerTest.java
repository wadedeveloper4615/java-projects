...
class InstantFieldValueChangerTest {
	...
	return Stream.of(new AreDifferentCase(null, null, false), new AreDifferentCase(instant1, instant1, false), new AreDifferentCase(null, instant2, true), new AreDifferentCase(instant1, null, true), new AreDifferentCase(instant1, instant2, true)).map(value -> dynamicTest(getDefaultDisplayName(value.value1 + " " + value.value2), Should_Return_True_Or_False_Whether_Values_Are_Different_Or_Not(value)));
    }
