...
class IterableValueChangerTest {
	...
	return Stream.of(new AreDifferentCase(null, null, false), new AreDifferentCase(emptyArrayList, emptyArrayList, false), new AreDifferentCase(collectionABC, collectionABC, false), new AreDifferentCase(null, emptyArrayList, true), new AreDifferentCase(emptyArrayList, null, true), new AreDifferentCase(collectionAB_1, collectionABC, true), new AreDifferentCase(collectionAB_1, collectionAB_2, false))
