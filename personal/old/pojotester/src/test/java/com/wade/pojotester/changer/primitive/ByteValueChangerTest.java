...
class ByteValueChangerTest {
	...
	return Stream.of(Byte.MAX_VALUE, Byte.MIN_VALUE, (byte) 0, (byte) -1, (byte) 1).map(value -> dynamicTest(getDefaultDisplayName(value), Should_Change_Primitive_Value(value)));
    }
	...
	return Stream.of(Byte.MAX_VALUE, Byte.MIN_VALUE, (byte) 0, (byte) -1, (byte) 1).map(value -> dynamicTest(getDefaultDisplayName(value), Should_Change_Wrapped_Value(value)));
    }
	...
	return Stream.of(new TestCase(null, null, false), new TestCase((byte) 0, (byte) 0, false), new TestCase(Byte.MIN_VALUE, Byte.MIN_VALUE, false), new TestCase(Byte.MAX_VALUE, Byte.MAX_VALUE, false), new TestCase((byte) 0, (byte) 1, true), new TestCase((byte) 0, null, true), new TestCase(null, Byte.MIN_VALUE, true), new TestCase(Byte.MIN_VALUE, Byte.MAX_VALUE, true), new TestCase(Byte.MAX_VALUE, Byte.MIN_VALUE, true))
