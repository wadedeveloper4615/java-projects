...
class IntegerValueChangerTest {
	...
	return Stream.of(Integer.MAX_VALUE, Integer.MIN_VALUE, 0, -1, 1).map(value -> dynamicTest(getDefaultDisplayName(value), Should_Change_Primitive_Value(value)));
    }
	...
	return Stream.of(Integer.MAX_VALUE, Integer.MIN_VALUE, 0, -1, 1).map(value -> dynamicTest(getDefaultDisplayName(value), Should_Change_Wrapped_Value(value)));
    }
	...
	return Stream.of(new TestCase(null, null, false), new TestCase(0, 0, false), new TestCase(Integer.MIN_VALUE, Integer.MIN_VALUE, false), new TestCase(Integer.MAX_VALUE, Integer.MAX_VALUE, false), new TestCase(0, 1, true), new TestCase(0, null, true), new TestCase(null, Integer.MIN_VALUE, true), new TestCase(Integer.MIN_VALUE, Integer.MAX_VALUE, true), new TestCase(Integer.MAX_VALUE, Integer.MIN_VALUE, true))
