...
class FloatValueChangerTest {
	...
	return Stream.of(Float.MAX_VALUE, Float.MIN_VALUE, Float.MIN_NORMAL, (float) 0, (float) -1, (float) 1).map(value -> dynamicTest(getDefaultDisplayName(value), Should_Change_Primitive_Value(value)));
    }
	...
	return Stream.of(Float.MAX_VALUE, Float.MIN_VALUE, Float.MIN_NORMAL, (float) 0, (float) -1, (float) 1).map(value -> dynamicTest(getDefaultDisplayName(value), Should_Change_Wrapped_Value(value)));
    }
	...
	return Stream.of(new TestCase(null, null, false), new TestCase((float) 0, (float) 0, false), new TestCase(Float.MIN_VALUE, Float.MIN_VALUE, false), new TestCase(Float.MAX_VALUE, Float.MAX_VALUE, false), new TestCase((float) 0, (float) 1, true), new TestCase((float) 0, null, true), new TestCase(null, Float.MIN_VALUE, true), new TestCase(Float.MIN_VALUE, Float.MAX_VALUE, true), new TestCase(Float.MAX_VALUE, Float.MIN_VALUE, true))
