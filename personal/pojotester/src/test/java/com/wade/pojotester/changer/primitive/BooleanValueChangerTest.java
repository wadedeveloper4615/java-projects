...
class BooleanValueChangerTest {
	...
	return Stream.of(Boolean.TRUE, Boolean.FALSE).map(value -> dynamicTest(getDefaultDisplayName(value), Should_Change_Primitive_Value(value)));
    }
	...
	return Stream.of(Boolean.TRUE, Boolean.FALSE).map(value -> dynamicTest(getDefaultDisplayName(value), Should_Change_Wrapped_Value(value)));
    }
	...
	return Stream.of(new TestCase(null, null, false), new TestCase(false, false, false), new TestCase(Boolean.FALSE, Boolean.FALSE, false), new TestCase(Boolean.TRUE, Boolean.TRUE, false), new TestCase(false, true, true), new TestCase(false, null, true), new TestCase(null, Boolean.FALSE, true), new TestCase(Boolean.FALSE, Boolean.TRUE, true), new TestCase(Boolean.TRUE, Boolean.FALSE, true))
