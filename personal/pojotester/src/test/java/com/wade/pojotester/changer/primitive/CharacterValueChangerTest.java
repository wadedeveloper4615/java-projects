...
class CharacterValueChangerTest {
	...
	return Stream.of(Character.MAX_VALUE, Character.MIN_VALUE, " ".toCharArray()[0]).map(value -> dynamicTest(getDefaultDisplayName(value), Should_Change_Primitive_Value(value)));
    }
	...
	return Stream.of(Character.MAX_VALUE, Character.MIN_VALUE, " ".toCharArray()[0]).map(value -> dynamicTest(getDefaultDisplayName(value), Should_Change_Wrapped_Value(value)));
    }
	...
	return Stream.of(new TestCase(null, null, false), new TestCase((char) 0, (char) 0, false), new TestCase(Character.MIN_VALUE, Character.MIN_VALUE, false), new TestCase(Character.MAX_VALUE, Character.MAX_VALUE, false), new TestCase((char) 0, (char) 1, true), new TestCase((char) 0, null, true), new TestCase(null, Character.MIN_VALUE, true), new TestCase(Character.MIN_VALUE, Character.MAX_VALUE, true), new TestCase(Character.MAX_VALUE, Character.MIN_VALUE, true))
