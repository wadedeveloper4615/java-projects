...
class BigDecimalValueChangerTest {
	...
	return Stream.of(BigDecimal.TEN, BigDecimal.ZERO, BigDecimal.ONE, BigDecimal.valueOf(999999999999999999L)).map(value -> dynamicTest(getDefaultDisplayName(value), Should_Change_Value(value)));
    }
	...
	return Stream.of(new TestCase(null, null, false), new TestCase(BigDecimal.ZERO, BigDecimal.ZERO, false), new TestCase(BigDecimal.valueOf(-999999999999999999L), BigDecimal.valueOf(-999999999999999999L), false), new TestCase(BigDecimal.valueOf(999999999999999999L), BigDecimal.valueOf(999999999999999999L), false), new TestCase(BigDecimal.ZERO, BigDecimal.ONE, true), new TestCase(BigDecimal.ZERO, null, true), new TestCase(null, BigDecimal.valueOf(-999999999999999999L), true),
		new TestCase(BigDecimal.valueOf(-999999999999999999L), BigDecimal.valueOf(999999999999999999L), true), new TestCase(BigDecimal.valueOf(999999999999999999L), BigDecimal.valueOf(-999999999999999999L), true)).map(value -> dynamicTest(getDefaultDisplayName(value.value1 + " " + value.value2), Should_Return_True_Or_False_Whether_Values_Are_Different_Or_Not(value)));
    }
