...
class DoubleValueChangerTest {
	...
	return Stream.of(Double.MAX_VALUE, Double.MIN_VALUE, Double.MIN_NORMAL, (double) 0, (double) -1, (double) 1).map(value -> dynamicTest(getDefaultDisplayName(value), Should_Change_Primitive_Value(value)));
    }
	...
	return Stream.of(Double.MAX_VALUE, Double.MIN_VALUE, Double.MIN_NORMAL, (double) 0, (double) -1, (double) 1).map(value -> dynamicTest(getDefaultDisplayName(value), Should_Change_Wrapped_Value(value)));
    }
	...
	return Stream.of(new TestCase(null, null, false), new TestCase((double) 0, (double) 0, false), new TestCase(Double.MIN_VALUE, Double.MIN_VALUE, false), new TestCase(Double.MAX_VALUE, Double.MAX_VALUE, false), new TestCase((double) 0, (double) 1, true), new TestCase((double) 0, null, true), new TestCase(null, Double.MIN_VALUE, true), new TestCase(Double.MIN_VALUE, Double.MAX_VALUE, true), new TestCase(Double.MAX_VALUE, Double.MIN_VALUE, true))
