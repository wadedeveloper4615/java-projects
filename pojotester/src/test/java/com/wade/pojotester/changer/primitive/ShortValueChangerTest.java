...
class ShortValueChangerTest {
	...
	return Stream.of(Short.MAX_VALUE, Short.MIN_VALUE, (short) 0, (short) -1, (short) 1).map(value -> dynamicTest(getDefaultDisplayName(value), Should_Change_Primitive_Value(value)));
    }
	...
	return Stream.of(Short.MAX_VALUE, Short.MIN_VALUE, (short) 0, (short) -1, (short) 1).map(value -> dynamicTest(getDefaultDisplayName(value), Should_Change_Wrapped_Value(value)));
    }
	...
	return Stream.of(new TestCase(null, null, false), new TestCase((short) 0, (short) 0, false), new TestCase(Short.MIN_VALUE, Short.MIN_VALUE, false), new TestCase(Short.MAX_VALUE, Short.MAX_VALUE, false), new TestCase((short) 0, (short) 1, true), new TestCase((short) 0, null, true), new TestCase(null, Short.MIN_VALUE, true), new TestCase(Short.MIN_VALUE, Short.MAX_VALUE, true), new TestCase(Short.MAX_VALUE, Short.MIN_VALUE, true))
