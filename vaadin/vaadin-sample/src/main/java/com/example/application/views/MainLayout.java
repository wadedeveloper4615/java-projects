...
import com.example.application.views.adminhomepage.AdminHomepageView;
...
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent() {
        H2 appName = new H2("Vaadin Sample");
    ...
    private List<RouterLink> createLinks() {
        MenuItemInfo[] menuItems = new MenuItemInfo[] { //
                new MenuItemInfo("Homepage", "la la-globe", HomepageView.class), //

                new MenuItemInfo("About", "la la-file", AboutView.class), //

                new MenuItemInfo("Admin Homepage", "la la-globe", AdminHomepageView.class), //
